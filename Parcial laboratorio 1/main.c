    ...
    do
    {
         menu(&opcionMenu);
            ...
            case 13:
                ...
                {
                    printf("Error, no hay clientes para listar\n");
                }
                break;
            ...
            case 14:
                if(!verificarExistenciaCliente(listaDeClientes,TAM_CLIENTES))
                {
                    ...
                    mostrarLocalidadConMasClientes(listaDeClientes,listaDeLocalidades,TAM_CLIENTES,TAM_LOCALIDADES);
                ...
                if(!verificarExistenciaCliente(listaDeClientes,TAM_CLIENTES) && !verificarExistenciaAlquiler(listaDeAlquileres,TAM_ALQUILERES))
                {
                    ...
                    listarJuegosAlquiladosPorMujeres(listaDeClientes,listaDeLocalidades,listaDeAlquileres,listaDeJuegos,TAM_ALQUILERES,TAM_CLIENTES,TAM_LOCALIDADES,TAM_JUEGOS);
                }
                else
                {
                    printf("Error, no hay clientes para listar\n");
                ...
                if(!verificarExistenciaCliente(listaDeClientes,TAM_CLIENTES) && !verificarExistenciaAlquiler(listaDeAlquileres,TAM_ALQUILERES))
                {
                    ...
                    juegoPreferidoDeHombres(listaDeClientes,listaDeLocalidades,listaDeJuegos,listaDeAlquileres,TAM_ALQUILERES,TAM_CLIENTES,TAM_LOCALIDADES,TAM_JUEGOS);
                ...
                if(!verificarExistenciaCliente(listaDeClientes,TAM_CLIENTES) && !verificarExistenciaAlquiler(listaDeAlquileres,TAM_ALQUILERES))
                {
                        ...
                        mostrarClientesPorJuego(listaDeClientes,listaDeJuegos,listaDeLocalidades,listaDeAlquileres,TAM_ALQUILERES,TAM_CLIENTES,TAM_JUEGOS,TAM_LOCALIDADES);
                }
                else
                {
                    printf("Error, no hay clientes para listar\n");
                ...
                if(!verificarExistenciaCliente(listaDeClientes,TAM_CLIENTES) && !verificarExistenciaAlquiler(listaDeAlquileres,TAM_ALQUILERES))
                {
                    mostrarAcumuladoPorFecha(listaDeAlquileres,listaDeJuegos,listaDeClientes,listaDeLocalidades,TAM_LOCALIDADES,TAM_ALQUILERES,TAM_JUEGOS,TAM_CLIENTES);
                }
                else
                {
                    printf("Error, no hay clientes para listar\n");
